Create one horizontal animation strip for Codex pet `steve`, state `running-right`.
...
Identity: same pet in every frame: Minecraft Steve-inspired compact pet, classic blocky pixel-art humanoid, square head, medium-brown block hair, subtle pixel beard shadow, turquoise shirt, indigo blue pants, gray shoes, friendly calm face, no props, full-body centered, readable at small sprite size, clean chroma background.. Preserve silhouette, face, proportions, markings, palette, material, style, and props.
Style: Pet-safe sprite: compact full-body mascot, readable in a 192x208 cell, clear silhouette, simple face, stable palette/materials, and crisp edges for chroma-key extraction. Style `pixel`: Pixel-art-adjacent digital mascot with a chunky silhouette, simple dark outline, limited palette, flat cel shading, and visible stepped edges. User style notes: Preserve a crisp Minecraft-like voxel silhouette and classic pixel palette while keeping the pet compact and animation-friendly..
